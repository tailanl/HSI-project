# v2接触与脚滑规则：不提前锁住未来落脚点

训练、采样和refine共用本策略。required_contact是必须完成的关系，established是当前几何状态，二者不能混用。建立接触只末帧要求，明确保持关系覆盖对应区间；脚滑只在同一实际支撑目标的连续帧对上计算。支撑对数量0时slip=0不等于步态改善。

下面是备份源码的逐字摘录，不是伪代码，也不是独立可执行模块。完整imports、辅助函数和校验仍在对应原文件中。

## event_contact_state

来源：[hsi/stage3_joint_v2/contacts.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/contacts.py:32)，原文件第 32–94 行。
...
## contact_event_losses

来源：[hsi/stage3_joint_v2/contacts.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/contacts.py:97)，原文件第 97–133 行。
...
来源：[hsi/stage3_joint_v2/contacts.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/contacts.py:136)，原文件第 136–210 行。
...
来源：[hsi/stage3_joint_v2/contacts.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/contacts.py:213)，原文件第 213–222 行。
...
来源：[hsi/stage3_joint_v2/objectives.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/objectives.py:23)，原文件第 23–31 行。
...
来源：[hsi/stage3_joint_v2/objectives.py](/home/lzsh2025/kimodo-viser/kimodo_scene_project/agent9/stage3_core_20260909/source/hsi/stage3_joint_v2/objectives.py:34)，原文件第 34–55 行。
