"""V2 U15 shared contact/stance policy: bounded whole-sequence mesh/SDF refinement after learned sampling.
...
from hsi.stage3_joint_v2.contacts import POLICY_VERSION, event_contact_state, contact_event_losses, foot_slip_terms
